...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->translation['file_error']                  = 'Chyba súboru. Prosím skúste znova.';
        $this->translation['local_file_missing']          = 'Lokálny súbor neexistuje.';
        $this->translation['local_file_not_readable']     = 'Lokálny súbor je nečitateľný.';
        $this->translation['uploaded_too_big_ini']        = 'Chyba odosielania súboru (odosielaný súbor presahuje nastevenú hodnotu upload_max_filesize v php.ini).';
        $this->translation['uploaded_too_big_html']       = 'Chyba odosielania súboru (odosielaný súbor presahuje hodnotu MAX_FILE_SIZE, která bola nastavená v HTML formulári).';
        $this->translation['uploaded_partial']            = 'Chyba odosielania súboru (odoslaná iba časť súboru).';
        $this->translation['uploaded_missing']            = 'Chyba odosielania súboru (nebol odoslaný žiaden súbor).';
        $this->translation['uploaded_unknown']            = 'Chyba odosielania súboru (neznámy chybový kód).';
        $this->translation['try_again']                   = 'Chyba odosielania súboru. Prosím skúste znova.';
        $this->translation['file_too_big']                = 'Súbor je príliš veľký.';
        $this->translation['no_mime']                     = 'Nie je možné zistiť MIME typ.';
        $this->translation['incorrect_file']              = 'Nesprávny typ súboru.';
        $this->translation['image_too_wide']              = 'Obrázok je veľmi široký.';
        $this->translation['image_too_narrow']            = 'Obrázok je veľmi úzky.';
        $this->translation['image_too_high']              = 'Obrázok je veľmi vysoký.';
        $this->translation['image_too_short']             = 'Obrázok je veľmi nízky.';
        $this->translation['ratio_too_high']              = 'Chybná proporcia obrázku (obrázok je veľmi široký).';
        $this->translation['ratio_too_low']               = 'Chybná proporcia obrázku (obrázok je veľmi vysoký).';
        $this->translation['too_many_pixels']             = 'Obrázok má príliš veľa pixelov.';
        $this->translation['not_enough_pixels']           = 'Obrázok nemá dostatok pixelov.';
        $this->translation['file_not_uploaded']           = 'Súbor nebol odoslaný. V procese sa nedá pokračovať.';
        $this->translation['already_exists']              = '%s už existuje. Prosím zmeňte názov súboru.';
        $this->translation['temp_file_missing']           = 'Nesprávny dočasný súbor. V procese sa nedá pokračovať.';
        $this->translation['source_missing']              = 'Nesprávny zdrojový súbor. V procese sa nedá pokračovať.';
        $this->translation['destination_dir']             = 'Nepodarilo sa vytvoriť cieľový adresár. V procese sa nedá pokračovať.';
        $this->translation['destination_dir_missing']     = 'Cieľový adresár neexistuje. V procese sa nedá pokračovať.';
        $this->translation['destination_path_not_dir']    = 'Cieľová cesta nieje adresár. V procese sa nedá pokračovať.';
        $this->translation['destination_dir_write']       = 'Cieľový adresár sa nedá zmeniť na zapisovateľný. V procese sa nedá pokračovať.';
        $this->translation['destination_path_write']      = 'Do cieľovej cesty sa nedá zapisovať. V procese sa nedá pokračovať.';
        $this->translation['temp_file']                   = 'Nie je možné vytvoriť dočasný súbor. V procese sa nedá pokračovať.';
        $this->translation['source_not_readable']         = 'Zdrojový súbor sa nedá čítať. V procese sa nedá pokračovať.';
        $this->translation['no_create_support']           = 'Nie je zapnutá podpora zápisu %s.';
        $this->translation['create_error']                = 'Chyba pri vytváraní %s obrázku zo zdroja.';
        $this->translation['source_invalid']              = 'Nepodarilo sa prečítať zdroj obrázku. Je súbor obrázok?.';
        $this->translation['gd_missing']                  = 'Pravdepodobne chýba GD knižnica.';
        $this->translation['watermark_no_create_support'] = 'Nie je zapnutá podpora zápisu %s, vodoznak sa nedá prečítať.';
        $this->translation['watermark_create_error']      = 'Nie je zapnutá podpora čítania %s, vodoznak sa nedá prečítať.';
        $this->translation['watermark_invalid']           = 'Neznámy formát obrázku, vodoznak sa nedá prečítať.';
        $this->translation['file_create']                 = 'Nie je zapnutá podpora pre vytváranie %s.';
        $this->translation['no_conversion_type']          = 'Nedefinovaný typ konverzie.';
        $this->translation['copy_failed']                 = 'Chyba kopírovania súboru na serveri. Funkcia copy() zlyhala.';
        $this->translation['reading_failed']              = 'Chyba čítania súboru.';
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                $this->file_dst_name_body = utf8_encode(strtr(utf8_decode($this->file_dst_name_body), utf8_decode('ŠŽšž??ÁÂ?Ä?Ç?É?Ë?ÍÎ???ÓÔ?Ö??Ú?ÜÝ?áâ?ä?ç?é?ë?íî???óô?ö??ú?üý?'), 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy'));
                $this->file_dst_name_body = strtr($this->file_dst_name_body, array('?' => 'TH', '?' => 'th', '?' => 'DH', '?' => 'dh', 'ß' => 'ss', '?' => 'OE', '?' => 'oe', '?' => 'AE', '?' => 'ae', 'µ' => 'u'));
